                    ...
                    <form action="{{ route('levels.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group shadow-sm rounded-3 overflow-hidden">
                                ...
                                <input type="text" name="name" class="form-control bg-light border-start-0 ps-2" value="{{ old('name') }}" placeholder="e.g. N4">
                            </div>
                            @error('name')
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group shadow-sm rounded-3 overflow-hidden">
                                ...
                                <input type="text" name="description" class="form-control bg-light border-start-0 ps-2" value="{{ old('description') }}" placeholder="Brief description of this proficiency tier">
                            </div>
                            @error('description')
                                <p class="text-danger small mt-1 mb-0"><i class="fa-solid fa-circle-exclamation me-1"></i> {{ $message }}</p>
                            @enderror
